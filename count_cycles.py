...
df['shift'] = df['time'].dt.hour.apply(assign_shift)
...
def shift_is_full(shift_group):
    ...
    if shift_name == 'morning':
        ...
        return start_time.hour <= 22 or end_time.hour >= 5
...
cycles['shift'] = cycles['start_time'].dt.hour.apply(assign_shift)
cycles['shift_date'] = cycles['start_time'].dt.date
